...
; wFastShip1FSceneID
	...
	const_def 1
	const SCENE_CIANWOODPHARMACY_ROCKET_SCENE
	const SCENE_CIANWOODPHARMACY_ROCKET_NOTHING

	const_def 1
	const SCENE_VERMILIONCITY_OAK

	const_def 1
	const SCENE_OAKS_LAB_KANTOJOURNEY ; 1
	
	const_def 1
	const SCENE_PALLET_TOWN_OAK ; 1
	const SCENE_PALLET_TOWN_CANTLEAVE ; 1
