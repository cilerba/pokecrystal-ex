...
; HMs (EVENT_GOT_HM07_WATERFALL is with the Johto itemballs)
	const EVENT_GOT_DOUBLE_TEAM; EVENT_GOT_HM01_CUT
	...
	const EVENT_LINKCABLEKID_SET ; unused
; Rods
...
; Crystal-exclusive events in Johto
	...
	const EVENT_ECRUTEAK_ROADBLOCK
	const EVENT_GOT_PC_LINK
	const EVENT_POST_CHUCK_ROCKET
	const EVENT_POST_CHUCK_ROCKET_DEFEATED
; Unused: next 2 events, updated
...
; Kanto hidden items
	...
	const EVENT_FOUND_CUT
	const EVENT_FOUND_FLY
	const EVENT_FOUND_SURF
	const EVENT_FOUND_STRENGTH
