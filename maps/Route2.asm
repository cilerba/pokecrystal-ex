	...
	const ROUTE2_ROADBLOCK_BUG_CATCHER
...
Route2RoadBlock:
	jumptext Route2RoadBlockText

Route2RoadBlock2:
	jumptext Route2RoadBlock2Text
...
Route2RoadBlock2Text:
	text "I wanted to get"
	line "to VERMILION"
	
	para "CITY but there's"
	line "an angry DUGTRIO"
	cont "blocking me."
...
Route2_MapEvents:
	...
	warp_event  3, 33, ROUTE_2_SOUTH_GATE, 3
	...
	object_event 15, 32, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 5, Route2RoadBlock, ENGINE_CASCADEBADGE
	object_event 12,  8, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 5, Route2RoadBlock2, ENGINE_CASCADEBADGE
