...
Rival1Group:
	...
	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 42, CROBAT,     SWIFT, SLUDGE_BOMB, SCREECH, HAZE
	db 42, MAGNETON,  SCREECH, SWIFT, THUNDERSHOCK, LIGHT_SCREEN
	db 43, GENGAR,    HYPNOSIS, DREAM_EATER, SHADOW_BALL, CONFUSE_RAY
	db 44, SNEASEL,    CRUNCH, FURY_SWIPES, FAINT_ATTACK, SCREECH
	db 44, MEGANIUM,   LIGHT_SCREEN, BODY_SLAM, PETAL_DANCE, SYNTHESIS
	db -1 ; end
	...
	db 43, GENGAR,    HYPNOSIS, DREAM_EATER, SHADOW_BALL, CONFUSE_RAY
	db 44, SNEASEL,    CRUNCH, FURY_SWIPES, FAINT_ATTACK, SCREECH
	db 44, TYPHLOSION,    FLAMETHROWER, SWIFT, QUICK_ATTACK, SMOKESCREEN
	db -1 ; end
	...
	db 43, GENGAR,    HYPNOSIS, DREAM_EATER, SHADOW_BALL, CONFUSE_RAY
	db 44, SNEASEL,    CRUNCH, FURY_SWIPES, FAINT_ATTACK, SCREECH
	db 44, FERALIGATR, ICE_PUNCH, CRUNCH, SURF, SCREECH
	db -1 ; end
