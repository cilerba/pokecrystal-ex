...
FalknerGroup:
	...
	db  13, MURKROW,  	TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db -1 ; end
...
WhitneyGroup:
	...
	db 22, GRANBULL,   TACKLE, BITE, CHARM, SCARY_FACE
...
BugsyGroup:
	...
	db 20, HERACROSS,  FURY_CUTTER, HORN_ATTACK, ROCK_SMASH, NO_MOVE
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 24, HAUNTER,	   BITE, CONFUSE_RAY, NIGHT_SHADE, SPITE
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 25, MISDREAVUS,    PSYBEAM, MEAN_LOOK, SHADOW_BALL, CONFUSE_RAY
	db 27, MISDREAVUS,    PSYBEAM, SPITE, SHADOW_BALL, LICK
	db -1 ; end
...
JasmineGroup:
	...
	db 33, FORRETRESS, SELFDESTRUCT, SPIKES, SANDSTORM, HEADBUTT
	db 35, MAGNETON, SONICBOOM, THUNDERBOLT, TRI_ATTACK, SUPERSONIC
	db 36, SKARMORY, STEEL_WING, AGILITY, WING_ATTACK, SPIKES
	db 37, STEELIX, CRUNCH, ROCK_SLIDE, IRON_TAIL, DRAGONBREATH
	db -1 ; end
...
ChuckGroup:
	...
	db 31, HITMONLEE,   LEER, RAGE, KARATE_CHOP, FURY_SWIPES
	db 31, HITMONCHAN,   LEER, RAGE, KARATE_CHOP, FURY_SWIPES
	db 33, HITMONTOP,   LEER, RAGE, KARATE_CHOP, FURY_SWIPES
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 46, PUPITAR, ROCK_SLIDE, SCARY_FACE, EARTHQUAKE, SANDSTORM
	db 47, DRAGONAIR, DRAGONBREATH, THUNDER_WAVE, TWISTER, SLAM
	db 47, DRAGONAIR, DRAGONBREATH, TWISTER, AGILITY, DRAGON_RAGE
	db 47, HOUNDOOM, FLAMETHROWER, BITE, SMOG, THIEF
	db 48, GYARADOS, TWISTER, DRAGONBREATH, WHIRLPOOL, HYDRO_PUMP
	db 48, KINGDRA, TWISTER, AGILITY, DRAGONBREATH, SURF
	db -1 ; end
...
Rival1Group:
	...
	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 40, CROBAT,     SWIFT, SLUDGE_BOMB, SCREECH, HAZE
	db 41, MAGNETON,  SCREECH, SWIFT, THUNDERSHOCK, LIGHT_SCREEN
	db 42, GENGAR,    HYPNOSIS, DREAM_EATER, SHADOW_BALL, CONFUSE_RAY
	db 43, SNEASEL,    CRUNCH, FURY_SWIPES, FAINT_ATTACK, SCREECH
	db 43, MEGANIUM,   LIGHT_SCREEN, BODY_SLAM, PETAL_DANCE, SYNTHESIS
	db -1 ; end
	...
	db 42, GENGAR,    HYPNOSIS, DREAM_EATER, SHADOW_BALL, CONFUSE_RAY
	db 43, SNEASEL,    CRUNCH, FURY_SWIPES, FAINT_ATTACK, SCREECH
	db 43, TYPHLOSION,    FLAMETHROWER, SWIFT, QUICK_ATTACK, SMOKESCREEN
	db -1 ; end
	...
	db 42, GENGAR,    HYPNOSIS, DREAM_EATER, SHADOW_BALL, CONFUSE_RAY
	db 43, SNEASEL,    CRUNCH, FURY_SWIPES, FAINT_ATTACK, SCREECH
	db 43, FERALIGATR, ICE_PUNCH, CRUNCH, SURF, SCREECH
	db -1 ; end
...
WillGroup:
	...
	db 52, XATU, PSYCHIC_M, RECOVER, PSYCH_UP, CONFUSE_RAY
	db 52, ESPEON, PSYCHIC_M, REFLECT, SYNTHESIS, PSYCH_UP
	db 51, EXEGGUTOR, PSYCHIC_M, RECOVER, SLEEP_POWDER, POISONPOWDER
	db 51, SLOWKING, SURF, PSYBEAM, AMNESIA, SWAGGER
	db 52, JYNX, VITAL_THROW, ICE_PUNCH, BODY_SLAM, PERISH_SONG
	db 53, ALAKAZAM, PSYCHIC_M, RECOVER, REFLECT, DISABLE
	db -1 ; end
...
BrunoGroup:
	...
	db 52, PRIMEAPE, FAINT_ATTACK, THRASH, DYNAMICPUNCH, SCREECH
	db 53, HITMONLEE, MEGA_KICK, HI_JUMP_KICK, FIRE_SPIN, ENDURE
	db 53, HITMONCHAN, SUBMISSION, BARRIER, THUNDERPUNCH, DETECT
	db 54, HITMONTOP, TRIPLE_KICK, ROLLING_KICK, DETECT, FOCUS_ENERGY
	db 53, MACHAMP, CROSS_CHOP, MEDITATE, SUBMISSION, STRENGTH
	db 53, STEELIX, IRON_TAIL, CRUNCH, ROCK_SLIDE, SCREECH
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 52, UMBREON, MEAN_LOOK, CRUNCH, BARRIER, MOONLIGHT
	db 52, VILEPLUME, TOXIC, GIGA_DRAIN, MOONLIGHT, PETAL_DANCE
	db 53, GENGAR, HYPNOSIS, DREAM_EATER, SHADOW_BALL, DESTINY_BOND
	db 53, MURKROW, THIEF, SHARPEN, SKY_ATTACK, FAINT_ATTACK
	db 52, HOUNDOOM, FLAMETHROWER, THIEF, CRUNCH, SMOG
	db 53, WOBBUFFET, COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 52, FORRETRESS, SPIKES, RECOVER, EXPLOSION, DOUBLE_EDGE
	db 52, VENOMOTH, SLUDGE_BOMB, LEECH_LIFE, PSYBEAM, POISONPOWDER
	db 51, MUK, MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, SCREECH
	db 51, CROBAT, SLUDGE_BOMB, FLY, DETECT, LEECH_LIFE
	db 52, WEEZING, EXPLOSION, SLUDGE_BOMB, PURSUIT, FAINT_ATTACK
	db 53, ARIADOS, SWORDS_DANCE, PIN_MISSILE, TOXIC, AGILITY
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_MOVES
	db 53, GYARADOS, DRAGON_RAGE, CRUNCH, HYDRO_PUMP, SKY_ATTACK
	db 54, DRAGONITE, DRAGONBREATH, WATERFALL, AGILITY, SLAM
	db 55, TYRANITAR, THUNDERPUNCH, CRUNCH, EARTHQUAKE, ROCK_SLIDE
	db 54, CHARIZARD, DRAGON_RAGE, DRAGONBREATH, FLAMETHROWER, FLY
	db 57, KINGDRA, DRAGONBREATH, HYDRO_PUMP, AGILITY, WATERFALL
	db 58, DRAGONITE, THUNDERBOLT, DRAGONBREATH, HYPER_BEAM, FIRE_PUNCH
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 43, PIDGEOT,    SAND_ATTACK, QUICK_ATTACK, WHIRLWIND, FLY
...
HikerGroup:
	...
	db 45, DUGTRIO,    MAGNITUDE, DIG, SAND_ATTACK, SLASH
	db -1 ; end
...
BurglarGroup:
	...
	db 39, ARCANINE,  EXTREMESPEED, FLAMETHROWER, CRUNCH, TAKE_DOWN
	db 40, WEEZING, SLUDGE_BOMB, EXPLOSION, HAZE, DESTINY_BOND
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 43, URSARING, CHARM, REST, SNORE, THRASH
	db 43, HOUNDOOM, FLAMETHROWER, CRUNCH, DETECT, SWIFT
	db 44, TENTACRUEL, SCREECH, BUBBLEBEAM, SLUDGE_BOMB, SPIKES
	db 44, PERSIAN, SLASH, QUICK_ATTACK, FOCUS_ENERGY, THIEF
	db 45, ALAKAZAM, PSYCHIC_M, RECOVER, FUTURE_SIGHT, REFLECT
	db -1 ; end

	; EXECUTIVEM (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 42, WEEZING,	ROLLOUT, HAZE, SLUDGE_BOMB, EXPLOSION
	db 42, MUK, TOXIC, SLUDGE_BOMB, SCREECH, MINIMIZE
	db 43, GOLEM, EARTHQUAKE, ROCK_THROW, SPIKES, SELFDESTRUCT
	db 44, SMEARGLE, LIGHT_SCREEN, TOXIC, BATON_PASS, HEADBUTT
	db 45, CROBAT, SLUDGE_BOMB, LEECH_LIFE, SWIFT, WING_ATTACK
	db -1 ; end
	...
	db 42, MUK, TOXIC, SLUDGE_BOMB, SCREECH, MINIMIZE
	db 43, GOLEM, EARTHQUAKE, ROCK_THROW, SPIKES, SELFDESTRUCT
	db 43, MACHAMP, SUBMISSION, JUMP_KICK, FORESIGHT, DOUBLE_TEAM
	db 44, CROBAT, SLUDGE_BOMB, LEECH_LIFE, SWIFT, WING_ATTACK
	db -1 ; end
...
PicnickerGroup:
	...
	; PICNICKER (20)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 32, CLEFAIRY,   ENCORE, SING, DOUBLESLAP, MINIMIZE
	db -1 ; end
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 41, ARIADOS, SWORDS_DANCE, PIN_MISSILE, BITE, SCARY_FACE
	db 42, VILEPLUME, TOXIC, GIGA_DRAIN, MOONLIGHT, RAZOR_LEAF
	db 43, NINETALES, FLAMETHROWER, SHADOW_BALL, FAINT_ATTACK, CONFUSE_RAY
	db 45, CROBAT, SLUDGE_BOMB, HAZE, MEAN_LOOK, WING_ATTACK
	db 46, GRANBULL, TAKE_DOWN, RAGE, CHARM, SCARY_FACE
	db -1 ; end

	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 37, ARBOK,      WRAP, LEER, POISON_STING, BITE
	db 37, VILEPLUME,      ABSORB, SWEET_SCENT, SLEEP_POWDER, ACID
	db 38, MURKROW,    PECK, PURSUIT, HAZE, NO_MOVE
	db 39, GRANBULL,    HEADBUTT, PROTECT, SWAGGER, BITE
	db -1 ; end
...
KimonoGirlGroup:
	...
	db 20, FLAREON,		EMBER, SMOG, QUICK_ATTACK, CHARM
	db -1 ; end

	; KIMONO_GIRL (3)
	db "SAYO@", TRAINERTYPE_MOVES
	db 20, ESPEON,		CONFUSION, SWIFT, QUICK_ATTACK, CHARM	
	db -1 ; end

	; KIMONO_GIRL (4)
	db "ZUKI@", TRAINERTYPE_MOVES
	db 20, UMBREON,		PURSUIT, CONFUSE_RAY, QUICK_ATTACK, CHARM
	db -1 ; end

	; KIMONO_GIRL (5)
	db "KUNI@", TRAINERTYPE_MOVES
	db 20, VAPOREON,	WATER_GUN, HAZE, QUICK_ATTACK, CHARM
	db -1 ; end

	; KIMONO_GIRL (6)
	db "MIKI@", TRAINERTYPE_MOVES
	db 20, JOLTEON,		THUNDERSHOCK, THUNDER_WAVE, QUICK_ATTACK, CHARM
	db -1 ; end
...
TwinsGroup:
	...
	db 45, DRAGONAIR,    THUNDER_WAVE, TWISTER, FLAMETHROWER, HEADBUTT
	db 45, DRAGONAIR,    THUNDER_WAVE, TWISTER, ICE_BEAM, HEADBUTT
	db -1 ; end
