; MonMenuOptionStrings indexes
	...
	const MONMENUVALUE_NICKNAME ; 4
	const MONMENUVALUE_CANCEL ; 5
	const MONMENUVALUE_MOVE   ; 6
	const MONMENUVALUE_MAIL   ; 7
...
; options
	...
	db MONMENU_MENUOPTION, MONMENUITEM_NICKNAME,   MONMENUVALUE_NICKNAME
